...
var $mainUl = $(".Mainwrapper");
var $last = $mainUl.find("li.last");
var y = localStorage.getItem('y');
var yObject = JSON.parse(y);
...
var render = function render() {
  ...
  hashMap.forEach(function (node, index) {
    var $li = $("\n      <li>\n      <div class=\"wrapper\">\n        <div class=\"logo\">".concat(node.logo, "</div>\n        <div class=\"close\">\n        <svg class=\"icon\">\n        <use xlink:href=\"#icon-close\"></use>\n        </svg> \n        </div> \n      </div>\n      <div class=\"text\">").concat(simplyfyUrl(node.url), "</div>\n    </li>    \n      ")).insertBefore($last);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "35862" + '/');
